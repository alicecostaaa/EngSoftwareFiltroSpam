...
public class ReconhecedorSpam extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       // TreinadorSpam ts = new TreinadorSpam();
        NaiveBayesClassifier nbc = new NaiveBayesClassifier();
       // nbc.train(jTextField2.getText(), jTextField3.getText());
      //  nbc.setLing(ts.getCampoLing());
        //nbc.setSpam(ts.getCampoSpam());        
                
        
       //System.out.println("Ling:"+ling );
        //System.out.println("Spam:"+ nbc.getSpam() );
